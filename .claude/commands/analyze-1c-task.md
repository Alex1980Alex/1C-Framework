...
- Допущенные MCP-инструменты (`bsl-semantic-search`, `bsl-platform-context`, `1c-mcp-crud`, `pdf-vector-graph`, `ast-grep` через профиль bsl)
- Формат отчёта `ANALYSIS-REPORT.md`
