...
### 13.2 ИТС (its-research / its_fetch.py) — БСП/библиотечные/стандарты, ПЕРВИЧНО для БСП (выдержки + атрибуция [its.1c.ru, content/N] ИЛИ «не консультировались/не найдено» + причина)
