...
- **13.2 GitHub:** результат `scripts/ecosystem_scan.py "<query>"` (ADR-039) — найденные репозитории ИЛИ явное «релевантных репо не найдено» с причиной (config-specific / штатный механизм / окно свежести).
