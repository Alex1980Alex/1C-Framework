...
Процедура РассчитатьДанныеРегистрацииДляРМПриемкаТранспорта(Знач Регистрация) Экспорт
	...
	Если ТипЗнч(Регистрация) <> Тип("ДокументСсылка.гкс_РегистрацияНаПЛК") Тогда
		Возврат;
	КонецЕсли;	
...
Функция ПропуститьИнициализациюМестаРазгрузки(ВидПеревозки) Экспорт
	...
	Возврат гкс_ПриемкаТранспорта.ПропуститьИнициализациюМестаРазгрузки(ВидПеревозки);
...
// 
// Возвращаемое значение:
//  Структура - результат проверки блокировки
...
//	см. гкс_ПриемкаТранспорта.ЧасовойПоясПЛК
Функция ЧасовойПоясПЛК(ТочкаМаршрута) Экспорт
	Возврат гкс_ПриемкаТранспорта.ЧасовойПоясПЛК(ТочкаМаршрута);
КонецФункции
