...
Функция УчетныеМеханизмыКонфигурации() Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("гкс_ИспользоватьИнтеграциюСМорскойЛогистикой") Тогда
		МеханизмыКонфигурации.Вставить("МорскаяЛогистика", "гкс_МорскаяЛогистика");
	КонецЕсли;
	
	Если ПолучитьФункциональнуюОпцию("гкс_ИспользоватьИнтеграциюСWarehouse") Тогда
		МеханизмыКонфигурации.Вставить("РегистрацияВнешнихПроб", "гкс_УчетВнешнихПроб");
	КонецЕсли;
	
	МеханизмыКонфигурации.Вставить("ЗаданияНаКомпозитныеПробы", "гкс_РаботаСКомпозитнымиПробами");
