...
// Печать акт отбора проб завершение.
// 
// Параметры:
...
Процедура ПечатьАктОтбораПробЗавершение(ПараметрыПечати, ДополнительныеПараметры) Экспорт
	...
	ПечатьЗавершение(ПараметрыПечати, ДополнительныеПараметры);
...
Функция ВыполнитьКомандуПечати_ПФ_MXL_АктЗабраковкиПартии_ru(ОписаниеКоманды) Экспорт
	...
	Возврат СформироватьКомандуПечатиАктЗабраковки(ОписаниеКоманды);
...
//  Неопределено
//
Функция СформироватьКомандуПечатиАктЗабраковкиТовара_ру(ОписаниеКоманды) Экспорт

	Возврат СформироватьКомандуПечатиАктЗабраковки(ОписаниеКоманды);

КонецФункции

// Выполняет команду печати ПФ_MXL_ЯрлыкПробы.
//
// Параметры:
//  ОписаниеКоманды - Структура
//
...
// 	Неопределено
//
Функция КомандаПечати_ПФ_ЯрлыкПробы(ОписаниеКоманды) Экспорт
...
Функция СформироватьКомандуПечатиАктЗабраковки(ОписаниеКоманды)
...
Процедура ПечатьЗавершение(ПараметрыПечати, ДополнительныеПараметры)
