...
// Получает Документы регистрации по транспортным документам.
// 
// Параметры:
//  ТранспортныеДокументы - Массив из ДокументСсылка.гкс_ТранспортныйДокумент - Транспортные документы для отбора.
// 
// Возвращаемое значение:
//  ТаблицаЗначений - Документы регистрации по транспортным документам
Функция ДокументыРегистрацииПоТранспортнымДокументам(ТранспортныеДокументы) Экспорт
	
	Запрос = Новый Запрос;
	Запрос.УстановитьПараметр("ТранспортныеДокументы", ТранспортныеДокументы);
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	СвязьРегистрацииИТранспортногоДокумента.ДокументРегистрации КАК ДокументРегистрации,
	|	СвязьРегистрацииИТранспортногоДокумента.ТранспортныйДокумент КАК ТранспортныйДокумент
	...
	|	РегистрСведений.гкс_СвязьРегистрацииИТранспортногоДокумента КАК СвязьРегистрацииИТранспортногоДокумента
	|ГДЕ
	|	СвязьРегистрацииИТранспортногоДокумента.ТранспортныйДокумент В (&ТранспортныеДокументы)";
