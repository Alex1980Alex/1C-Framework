...
Результат вызова графа: {'a': 'установлено узлом_3'}
```
...
Вызовите граф с **недопустимым** входным сигналом.
...
## Объединение управления потоком выполнения и обновления состояния с помощью `Command`
