...
> **Phase 8 production reference (2026-04-30):** актуальная production-миграция (E5 1024d → Qwen3 4096d через TEI) задокументирована в [chapter 31](../31_QWEN3_RETRIEVAL_PRODUCTION/31.1_Обзор.md) и [roadmap §30](../../roadmap/260426_ROADMAP_PHASE_8_QWEN3_EMBEDDING_REINDEX.md). Примеры ниже — общая методология (применима для любой модели), Qdrant образ обновлён до `qdrant/qdrant:v1.17.1`.
