...
- `pdf-docs` (DOCS) — проиндексированная документация для RAG (`pdf_documents`+`wiki_pages_v1`). Qdrant. Immutable со стороны памяти: governance (TTL/versioning/_get_entity) отвечает `unsupported_source` осознанно (ADR P0.4 260612).
