...
> **Статус:** RESEARCH + ROADMAP + **W1 РЕАЛИЗОВАН** (2026-07-08, сабмодуль `ce11644`, parent `6030a30f1`, 331 unit passed) + **W2 B5.a/B5.b РЕАЛИЗОВАНЫ** (2026-07-09, сабмодуль `91e89a8`, 352 unit passed, code-verify PASS)
...
| 🟡 **W2** (надёжность) | B1 + B3 + B5 (**B5.a/b ✅**, B5.c/d ⬜) | ~11ч | Интерактивный JOB-step; sub-second trap; **переносимость на SVETLY/MFM ✅** |
