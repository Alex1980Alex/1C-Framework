...
- [ ] recall@10 улучшение ≥3% vs E5 baseline (runtime: запустить benchmark --compare local jina)
- [ ] Late Chunking опционально включается (Phase 48 — depends on Jina API research)
