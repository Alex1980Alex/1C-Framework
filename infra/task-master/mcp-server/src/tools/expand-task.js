...
export function registerExpandTaskTool(server) {
	server.addTool({
		name: 'expand_task',
		description: 'Expand a task into subtasks for detailed implementation. Supports PRD context preservation for enhanced expansion.',
		parameters: z.object({
			...
			withPrdContext: z
				...
				.optional()
				.default(false)
				.describe('Use PRD context for enhanced expansion (if available from task generation)'),
			preserveContext: z
				.boolean()
				.optional()
				.default(false)
				.describe('Preserve and enhance PRD context in generated subtasks')
		}),
