...
Функция ПолучитьТекстЗапросаПоКодуПробы()
	...
	|	ЕСТЬNULL(ДокументыЛабораторныйАнализ.Статус, ЗНАЧЕНИЕ(Перечисление.гкс_СтатусыЛабораторногоАнализа.ПустаяСсылка)) КАК СтатусЛабАнализа,
	...
	|	ЕСТЬNULL(КонтрагентыНоменклатурыЛИМС.Контрагент, ЕСТЬNULL(РегистрацияНаПЛК.Собственник, ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка))) КАК Собственник,
	...
	|	ПРЕДСТАВЛЕНИЕ(ЕСТЬNULL(КонтрагентыНоменклатурыЛИМС.Контрагент, ЕСТЬNULL(РегистрацияНаПЛК.Собственник,
	|			ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)))) КАК СобственникНаименование,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ЕСТЬNULL(ЛабораторныйАнализКачественныеПоказатели.Показатель, ЗНАЧЕНИЕ(Справочник.гкс_ПоказателиАнализовНоменклатуры.ПустаяСсылка)) КАК Показатель,
	...
	|ВЫБРАТЬ
	|	ФормированиеНомераПробыСписокРегистраций.ДокументРегистрации КАК ДокументРегистрации,
	|	ПРЕДСТАВЛЕНИЕ(ФормированиеНомераПробыСписокРегистраций.ДокументРегистрации.ТранспортноеСредство) КАК ТранспортноеСредствоНаименование
