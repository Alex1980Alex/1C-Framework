...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	ЗарегистрироватьОбработчикиОбновления_2026_03_01(Обработчики);
...
Процедура ЗарегистрироватьОбработчикиОбновления_2026_03_01(Обработчики)

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "*";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("b5c7d8e9-1a2b-3c4d-5e6f-789012345abc");
	Обработчик.Процедура =
		"РегистрыСведений.гкс_СопоставлениеФНПЛабАнализа.ПервоначальноеЗаполнениеСопоставлений";
	Обработчик.Комментарий =
		НСтр("ru = 'Первоначальное заполнение регистра сопоставления ФНП и ЛабораторныхАнализов.'");

	Обработчик.ЧитаемыеОбъекты = СтрШаблон("%1, %2, %3, %4, %5",
	...
	Обработчик.ИзменяемыеОбъекты = "РегистрСведений.гкс_СопоставлениеФНПЛабАнализа";
	Обработчик.БлокируемыеОбъекты = "РегистрСведений.гкс_СопоставлениеФНПЛабАнализа";

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "*";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("31cbc18d-23cc-4547-8ac3-48ccc5daec5c");
	Обработчик.Процедура =
		"Константы.гкс_ПериодОжиданияОтветаОтСРПВ.ПервоначальноеЗаполнение";
	Обработчик.Комментарий =
		НСтр("ru = 'Установка начального значения для константы Период ожидания ответа от СРПВ.'");

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "*";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("69e495f1-3d07-497b-b681-aa149031309b");
	Обработчик.Процедура =
		"РегистрыСведений.гкс_НастройкиУсиленногоКонтроляКачества.ЗаполнитьПризнакОтклонятьКачество";
	Обработчик.Комментарий =
		НСтр("ru = 'Заполнение признака отклонения по качеству в настройках усиленного контроля.'");

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "*";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("1b3aa35e-ae8d-451e-b26f-58754d3999fb");
	Обработчик.Процедура =
		"РегистрыСведений.гкс_ПоказателиУсиленногоКонтроляПоРегистрации.ЗаполнитьПризнакОтклонятьКачество";
	Обработчик.Комментарий =
		НСтр("ru = 'Заполнение признака отклонения по качеству в РС Показатели усиленного контроля.'");
