...
Процедура ОбновитьПредпросмотр(ТекущаяСтрока)
	...
	Если Не Предпросмотр
		...
		АдресДанныхФайла = "";
		// GKSTCPLK-2309 Начало
		Элементы.КартинкаПредпросмотра.Видимость = Истина;
		Элементы.ПолеПредпросмотраPDF.Видимость = Ложь;
		// GKSTCPLK-2309 Конец
		Возврат;
	КонецЕсли;
	...
	// Предпросмотр изображений (штатная логика)
	Элементы.КартинкаПредпросмотра.Видимость = Истина;
	Элементы.ПолеПредпросмотраPDF.Видимость = Ложь; // GKSTCPLK-2309
