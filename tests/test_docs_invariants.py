...
FILE_LEVEL_BANNERS = [
    ...
    # Строка узкая намеренно: голое "ARCHIVE" освобождало бы файлы со словами
    # «ARCHIVED-хроника» (37.x) и `MEMORY_INCLUDE_ARCHIVED` (27.10) — гард там
    # молча выключился бы на будущее.
    "ARCHIVE (устаревш",
]
