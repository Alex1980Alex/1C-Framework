 ...
 */
export function formatBSLAnalysisAsMarkdown(analysis, filePath) {
 ...
 */
export function createBSLSummary(analysis, filePath) {
    const fileName = path.basename(filePath);
 ...
 */
export async function analyzeBSLFile(filePath, content) {
 ...
 */
export function shouldDocumentBSLFile(analysis) {
 ...
 */
export function extractBSLKeyInfo(analysis) {
...
//# sourceMappingURL=bsl-integration.js.map