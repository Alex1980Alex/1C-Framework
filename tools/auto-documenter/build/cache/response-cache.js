...
export class ResponseCache {
     ...
     */
    generateKey(content, provider, model, promptType) {
     ...
     */
    async set(key, response, provider, model, promptType) {
        if (!this.config.enabled) {
            return;
        }
     ...
     */
    async enforceMaxSize(newEntrySize) {
...
export function withCache(cache, fn, options) {
    return (async (...args) => {
        ...
        const cacheKey = cache.generateKey(contentKey, options.provider, options.model, options.promptType);
