 ...
 */
export const bslMetadataPrompts = {
 ...
 */
export function getInlineDocsPrompt(fileExtension, symbolType = 'function') {
    // BSL files
 ...
 */
export function getBSLContextPrompt(moduleType, metadataType, symbolInfo) {
    const parts = [inlineDocsPrompts.bsl];
 ...
 */
export function formatCodeContext(code, filePath, symbolName) {
...
//# sourceMappingURL=inline-docs-prompts.js.map