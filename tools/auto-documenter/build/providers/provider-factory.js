...
export class ProviderFactory {
     ...
     */
    static createClient(provider, apiKey, model) {
     ...
     */
    static getApiKeyEnvVar(provider) {
        const envVars = {
     ...
     */
    static async createSmartClient(rotationURL = 'http://localhost:8000', ollamaURL = 'http://localhost:11434') {
     ...
     */
    static async isRotationAvailable(url = 'http://localhost:8000') {
     ...
     * @returns True if available
     */
    static async isOllamaAvailable(url = 'http://localhost:11434') {
     ...
     */
    static async ensureOllamaRunning(url = 'http://localhost:11434') {
