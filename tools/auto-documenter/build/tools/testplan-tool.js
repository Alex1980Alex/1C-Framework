 ...
 */
export class TestPlanTool extends BaseTool {
    /**
    ...
    constructor(apiKey, model, updateExisting) {
        ...
        super(toolConfig);
        this.name = 'autotestplan';
        this.description = 'Generates a test plan for code in a repository by recursively analyzing directories and files';
    ...
    async generate(directoryPath, analysisResult, isTopLevel = false, childrenContent, outputDir) {
        ...
        try {
            ...
            const genResult = await this.openRouterClient.generateWithCustomPrompt(files, systemPrompt, existingTestPlan || undefined, isTopLevel, childrenContent);
...
//# sourceMappingURL=testplan-tool.js.map