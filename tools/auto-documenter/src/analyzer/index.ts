...
import { analyzeBSLFile, EnhancedAnalysisFile } from './bsl-integration.js';

// Re-export BSL integration types and functions
export {
  EnhancedAnalysisFile,
  analyzeBSLFile,
  formatBSLAnalysisAsMarkdown,
  createBSLSummary,
  shouldDocumentBSLFile,
  extractBSLKeyInfo
} from './bsl-integration.js';
...
export {
  ...
  BSLElementType,
  getBSLAnalyzer
} from './bsl-treesitter-analyzer.js';
...
export class FileAnalyzer {
  ...
  private async processFile(filePath: string, result: AnalysisResult): Promise<void> {
    try {
      ...
      let analyzedFile: EnhancedAnalysisFile;
