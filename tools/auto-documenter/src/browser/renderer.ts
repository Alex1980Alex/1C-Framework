...
export class HtmlRenderer {
  ...
  constructor(title: string = 'Documentation Browser') {
    this.title = title;
  }
   ...
   */
  private renderTree(node: DirNode, currentPath: string = ''): string {
   ...
   * Render page layout
   */
  private renderLayout(content: string, tree: DirNode, currentPath: string = ''): string {
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
