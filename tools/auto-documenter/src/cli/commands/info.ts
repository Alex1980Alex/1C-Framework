...
import { PROVIDERS, DEFAULT_MODELS, getApiKey, Provider } from '../utils/options.js';
import { createOutput, Output } from '../utils/output.js';

/**
 * Check if provider is configured
 */
function checkProviderStatus(provider: Provider): { configured: boolean; reason: string } {
  if (provider === 'ollama') {
 ...
 */
function executeInfo(output: Output): void {
  console.log(banner);
