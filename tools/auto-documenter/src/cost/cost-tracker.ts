...
export interface BudgetLimit {
  ...
  warningThreshold?: number; // Warning at X% of limit (0-1)
}
...
export class CostTracker {
  ...
  private providerStats: Map<Provider, ProviderCostStats> = new Map();
  private startTime: Date;
  private budgetLimit?: BudgetLimit;
  private budgetWarningIssued: boolean = false;
   ...
   */
  private updateProviderStats(request: RequestCost): void {
