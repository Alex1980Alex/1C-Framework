...
export interface ModelPricing {
  ...
  isFree: boolean;     // Whether this is a free tier model
  dailyLimit?: {
...
export interface ProviderPricing {
  ...
  isFree: boolean; // Whether this provider has a free tier
}

/**
 * Complete pricing database for all providers
 */
export const PRICING_CONFIG: Record<Provider, ProviderPricing> = {
  /**
 ...
 */
export function getModelPricing(provider: Provider, model?: string): ModelPricing | undefined {
 ...
 */
export function isFreeModel(provider: Provider, model?: string): boolean {
  const pricing = getModelPricing(provider, model);
 ...
 */
export function getDailyLimits(provider: Provider, model?: string): ModelPricing['dailyLimit'] {
  const pricing = getModelPricing(provider, model);
 ...
 */
export function printPricingInfo(): void {
  console.error('\n💰 AI Provider Pricing:\n');
