  ...
  getInputSchema(): any {
    return {
      ...
      properties: {
        ...
        outputDir: {
          type: 'string',
          description: 'Output directory for generated documentation (optional). If specified, documentation files will be created in this directory with the same structure as the source. Use this for 1C configurations to avoid modifying the source directory.',
        },
        openRouterApiKey: {
          type: 'string',
