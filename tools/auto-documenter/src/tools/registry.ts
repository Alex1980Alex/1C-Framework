...
import { InlineDocsTool } from './inline-docs-tool.js';
import { DependencyGraphTool } from './dependency-graph-tool.js';
...
export class ToolRegistry {
  ...
  private registerTools(apiKey?: string, model?: string) {
    ...
    // Register inline docs tool
    const inlineDocsTool = new InlineDocsTool(apiKey, model);
    this.registerTool(inlineDocsTool);

    // Register dependency graph tool (hybrid: static analysis + LLM)
