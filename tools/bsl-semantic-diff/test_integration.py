...
Быстрая проверка работоспособности всех новых компонентов.
"""
...
def test_imports():
    ...
    try:
        ...
        print("✅ bsl_deep_analyzer импортирован успешно")

        from bsl_logic_analyzer import BslLogicAnalyzer, LogicFlow, LogicNode
        print("✅ bsl_logic_analyzer импортирован успешно")

        from bsl_html_visualizer import BslHtmlVisualizer
        print("✅ bsl_html_visualizer импортирован успешно")
        ...
        print("✅ mcp_server с новыми функциями импортирован успешно")
...
def test_deep_analyzer():
    ...
    try:
        ...
        print("✅ BslDeepAnalyzer создан успешно")
...
'''
        ...
        if analysis:
            print(f"✅ Анализ выполнен: найдено {len(analysis)} функций")
            ...
            print("⚠️ Анализ не вернул результатов")
        ...
        print(f"❌ Ошибка тестирования глубокого анализатора: {e}")
        return False
...
def test_logic_analyzer():
    ...
    try:
        ...
        print("✅ BslLogicAnalyzer создан успешно")
...
'''
        ...
        print(f"✅ Анализ логики выполнен:")
        ...
        print(f"❌ Ошибка тестирования анализатора логики: {e}")
        return False
...
def test_html_visualizer():
    ...
    try:
        ...
        print("✅ BslHtmlVisualizer создан успешно")
...
'''
        ...
        if success and output_path.exists():
            ...
            print(f"✅ HTML отчет создан: {file_size} байт")

            # Удаляем временные файлы
            temp_file.unlink()
            output_path.unlink()
        else:
            print("⚠️ HTML отчет не создан")

        return True

    except Exception as e:
        print(f"❌ Ошибка тестирования HTML визуализатора: {e}")
        return False
...
def main():
    ...
    if passed == total:
        print("🎉 ВСЕ ТЕСТЫ ПРОЙДЕНЫ! BSL Semantic Diff v2.0 готов к использованию")
    else:
        print("⚠️ Некоторые тесты не прошли. Проверьте зависимости и конфигурацию.")
