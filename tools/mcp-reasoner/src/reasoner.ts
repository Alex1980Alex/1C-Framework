...
export class Reasoner {
  ...
  constructor() {
    ...
    this.strategies.set(
      ReasoningStrategy.BSL_ARCHITECTURE,
      StrategyFactory.createStrategy(ReasoningStrategy.BSL_ARCHITECTURE, this.stateManager)
    );
    this.strategies.set(
      ReasoningStrategy.BSL_DOCUMENT_PATTERNS,
      StrategyFactory.createStrategy(ReasoningStrategy.BSL_DOCUMENT_PATTERNS, this.stateManager)
    );
    this.strategies.set(
      ReasoningStrategy.BSL_SUBSYSTEM_ANALYSIS,
      StrategyFactory.createStrategy(ReasoningStrategy.BSL_SUBSYSTEM_ANALYSIS, this.stateManager)
    );
